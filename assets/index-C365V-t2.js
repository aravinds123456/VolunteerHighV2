 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(x,L){var E=x.length;x.push(L);e:for(;0<E;){var D=E-1>>>1,ee=x[D];if(0<r(ee,L))x[D]=L,x[E]=ee,E=D;else break e}}function t(x){return x.length===0?null:x[0]}function o(x){if(x.length===0)return null;var L=x[0],E=x.pop();if(E!==L){x[0]=E;e:for(var D=0,ee=x.length,vo=ee>>>1;D<vo;){var Vn=2*(D+1)-1,Br=x[Vn],Ln=Vn+1,wo=x[Ln];if(0>r(Br,E))Ln<ee&&0>r(wo,Br)?(x[D]=wo,x[Ln]=E,D=Ln):(x[D]=Br,x[Vn]=E,D=Vn);else if(Ln<ee&&0>r(wo,E))x[D]=wo,x[Ln]=E,D=Ln;else break e}}return L}function r(x,L){var E=x.sortIndex-L.sortIndex;return E!==0?E:x.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var a=Date,s=a.now();e.unstable_now=function(){return a.now()-s}}var l=[],u=[],f=1,c=null,m=3,y=!1,v=!1,k=!1,M=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(x){for(var L=t(u);L!==null;){if(L.callback===null)o(u);else if(L.startTime<=x)o(u),L.sortIndex=L.expirationTime,n(l,L);else break;L=t(u)}}function w(x){if(k=!1,g(x),!v)if(t(l)!==null)v=!0,$n(b);else{var L=t(u);L!==null&&Oe(w,L.startTime-x)}}function b(x,L){v=!1,k&&(k=!1,p(V),V=-1),y=!0;var E=m;try{for(g(L),c=t(l);c!==null&&(!(c.expirationTime>L)||x&&!K());){var D=c.callback;if(typeof D=="function"){c.callback=null,m=c.priorityLevel;var ee=D(c.expirationTime<=L);L=e.unstable_now(),typeof ee=="function"?c.callback=ee:c===t(l)&&o(l),g(L)}else o(l);c=t(l)}if(c!==null)var vo=!0;else{var Vn=t(u);Vn!==null&&Oe(w,Vn.startTime-L),vo=!1}return vo}finally{c=null,m=E,y=!1}}var C=!1,T=null,V=-1,z=5,j=-1;function K(){return!(e.unstable_now()-j<z)}function q(){if(T!==null){var x=e.unstable_now();j=x;var L=!0;try{L=T(!0,x)}finally{L?Ne():(C=!1,T=null)}}else C=!1}var Ne;if(typeof d=="function")Ne=function(){d(q)};else if(typeof MessageChannel<"u"){var X=new MessageChannel,$e=X.port2;X.port1.onmessage=q,Ne=function(){$e.postMessage(null)}}else Ne=function(){M(q,0)};function $n(x){T=x,C||(C=!0,Ne())}function Oe(x,L){V=M(function(){x(e.unstable_now())},L)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(x){x.callback=null},e.unstable_continueExecution=function(){v||y||(v=!0,$n(b))},e.unstable_forceFrameRate=function(x){0>x||125<x?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):z=0<x?Math.floor(1e3/x):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return t(l)},e.unstable_next=function(x){switch(m){case 1:case 2:case 3:var L=3;break;default:L=m}var E=m;m=L;try{return x()}finally{m=E}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(x,L){switch(x){case 1:case 2:case 3:case 4:case 5:break;default:x=3}var E=m;m=x;try{return L()}finally{m=E}},e.unstable_scheduleCallback=function(x,L,E){var D=e.unstable_now();switch(typeof E=="object"&&E!==null?(E=E.delay,E=typeof E=="number"&&0<E?D+E:D):E=D,x){case 1:var ee=-1;break;case 2:ee=250;break;case 5:ee=1073741823;break;case 4:ee=1e4;break;default:ee=5e3}return ee=E+ee,x={id:f++,callback:L,priorityLevel:x,startTime:E,expirationTime:ee,sortIndex:-1},E>D?(x.sortIndex=E,n(u,x),t(l)===null&&x===t(u)&&(k?(p(V),V=-1):k=!0,Oe(w,E-D))):(x.sortIndex=ee,n(l,x),v||y||(v=!0,$n(b))),x},e.unstable_shouldYield=K,e.unstable_wrapCallback=function(x){var L=m;return function(){var E=m;m=L;try{return x.apply(this,arguments)}finally{m=E}}}})(iu);ru.exports=iu;var $c=ru.exports;/**
 * @license React
...
Volunteers still needed: 0`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00007iOb3jMAC",date:"2026-09-02"},{name:"Morning Kitchen Crew at St. Vincent de Paul",description:`We need your help to prepare and clean up as we create over 4,000 meals in the St. Vincent de Paul kitchen! No kitchen experience necessary.
...
Volunteers still needed: 18`,link:"https://www.handsonphoenix.org/opportunity/a0CUi000080x2vZMAQ",date:"2026-09-05"},{name:"From the Ground Up: Volunteer Day at the Ranch (Referral)",description:`Join us for a meaningful day of giving back at Wildcat Ranch Phoenix! This in-person volunteer event is a wonderful opportunity to roll up your sleeves, enjoy the outdoors, and make a direct impact on the ranch and the horses who call it home.
...
Volunteers still needed: 46`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00007QT15EMAT",date:"2026-09-05"},{name:"Maggie&#39;s Place Spruce Up",description:`Maggie’s Place provides safe housing and a nurturing community for homeless pregnant women, empowering them to thrive throughout their lifetime.
