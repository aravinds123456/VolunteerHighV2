 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Gc=P,_c=Symbol.for("react.element"),Fc=Symbol.for("react.fragment"),Hc=Object.prototype.hasOwnProperty,Bc=Gc.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Yc={key:!0,ref:!0,__self:!0,__source:!0};function tu(e,n,t){var o,r={},i=null,a=null;t!==void 0&&(i=""+t),n.key!==void 0&&(i=""+n.key),n.ref!==void 0&&(a=n.ref);for(o in n)Hc.call(n,o)&&!Yc.hasOwnProperty(o)&&(r[o]=n[o]);if(e&&e.defaultProps)for(o in n=e.defaultProps,n)r[o]===void 0&&(r[o]=n[o]);return{$$typeof:_c,type:e,key:i,ref:a,props:r,_owner:Bc.current}}xr.Fragment=Fc;xr.jsx=tu;xr.jsxs=tu;Yl.exports=xr;var p=Yl.exports,Si={},ou={exports:{}},xe={},ru={exports:{}},iu={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(M,E){var L=M.length;M.push(E);e:for(;0<L;){var G=L-1>>>1,ee=M[G];if(0<r(ee,E))M[G]=E,M[L]=ee,L=G;else break e}}function t(M){return M.length===0?null:M[0]}function o(M){if(M.length===0)return null;var E=M[0],L=M.pop();if(L!==E){M[0]=L;e:for(var G=0,ee=M.length,vo=ee>>>1;G<vo;){var Vn=2*(G+1)-1,Br=M[Vn],En=Vn+1,wo=M[En];if(0>r(Br,L))En<ee&&0>r(wo,Br)?(M[G]=wo,M[En]=L,G=En):(M[G]=Br,M[Vn]=L,G=Vn);else if(En<ee&&0>r(wo,L))M[G]=wo,M[En]=L,G=En;else break e}}return E}function r(M,E){var L=M.sortIndex-E.sortIndex;return L!==0?L:M.id-E.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var a=Date,s=a.now();e.unstable_now=function(){return a.now()-s}}var l=[],u=[],f=1,c=null,m=3,y=!1,v=!1,k=!1,x=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(M){for(var E=t(u);E!==null;){if(E.callback===null)o(u);else if(E.startTime<=M)o(u),E.sortIndex=E.expirationTime,n(l,E);else break;E=t(u)}}function w(M){if(k=!1,g(M),!v)if(t(l)!==null)v=!0,Zn(b);else{var E=t(u);E!==null&&Oe(w,E.startTime-M)}}function b(M,E){v=!1,k&&(k=!1,h(V),V=-1),y=!0;var L=m;try{for(g(E),c=t(l);c!==null&&(!(c.expirationTime>E)||M&&!K());){var G=c.callback;if(typeof G=="function"){c.callback=null,m=c.priorityLevel;var ee=G(c.expirationTime<=E);E=e.unstable_now(),typeof ee=="function"?c.callback=ee:c===t(l)&&o(l),g(E)}else o(l);c=t(l)}if(c!==null)var vo=!0;else{var Vn=t(u);Vn!==null&&Oe(w,Vn.startTime-E),vo=!1}return vo}finally{c=null,m=L,y=!1}}var C=!1,T=null,V=-1,R=5,j=-1;function K(){return!(e.unstable_now()-j<R)}function q(){if(T!==null){var M=e.unstable_now();j=M;var E=!0;try{E=T(!0,M)}finally{E?Ne():(C=!1,T=null)}}else C=!1}var Ne;if(typeof d=="function")Ne=function(){d(q)};else if(typeof MessageChannel<"u"){var X=new MessageChannel,Ze=X.port2;X.port1.onmessage=q,Ne=function(){Ze.postMessage(null)}}else Ne=function(){x(q,0)};function Zn(M){T=M,C||(C=!0,Ne())}function Oe(M,E){V=x(function(){M(e.unstable_now())},E)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(M){M.callback=null},e.unstable_continueExecution=function(){v||y||(v=!0,Zn(b))},e.unstable_forceFrameRate=function(M){0>M||125<M?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<M?Math.floor(1e3/M):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return t(l)},e.unstable_next=function(M){switch(m){case 1:case 2:case 3:var E=3;break;default:E=m}var L=m;m=E;try{return M()}finally{m=L}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(M,E){switch(M){case 1:case 2:case 3:case 4:case 5:break;default:M=3}var L=m;m=M;try{return E()}finally{m=L}},e.unstable_scheduleCallback=function(M,E,L){var G=e.unstable_now();switch(typeof L=="object"&&L!==null?(L=L.delay,L=typeof L=="number"&&0<L?G+L:G):L=G,M){case 1:var ee=-1;break;case 2:ee=250;break;case 5:ee=1073741823;break;case 4:ee=1e4;break;default:ee=5e3}return ee=L+ee,M={id:f++,callback:E,priorityLevel:M,startTime:L,expirationTime:ee,sortIndex:-1},L>G?(M.sortIndex=L,n(u,M),t(l)===null&&M===t(u)&&(k?(h(V),V=-1):k=!0,Oe(w,L-G))):(M.sortIndex=ee,n(l,M),v||y||(v=!0,Zn(b))),M},e.unstable_shouldYield=K,e.unstable_wrapCallback=function(M){var E=m;return function(){var L=m;m=E;try{return M.apply(this,arguments)}finally{m=L}}}})(iu);ru.exports=iu;var Zc=ru.exports;/**
 * @license React
...
Volunteers still needed: 1`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00008lD5KVMA0",date:"2026-10-10"},{name:"Classroom Prep Pros at Southwest Autism Research & Resource Center",description:`SARRC's mission is to advance research and provide a lifetime of support for individuals with autism and their families.
...
Volunteers still needed: 10`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00008Wws80MAB",date:"2026-10-17"},{name:"Medical Sort and Pack at Project C.U.R.E.",description:`Bring hope and health to the world with Project C.U.R.E., a national faith-based organization! Join us as we sort and pack desperately needed medical supplies that are shipped to hospitals, clinics, and orphanages in over 100 poverty stricken countries worldwide! Volunteers will meet new people and learn a lot about medical supplies and the urgent needs of them in under-resourced countries around the world.
...
Volunteers still needed: 7`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00008pLyRNMA0",date:"2026-10-17"},{name:"Garden Volunteers at Mesa Urban Farm",description:`The 3,000 square-foot Mesa Urban Farm provides about 500lbs of fresh produce monthly for St. Vincent de Paul's Mesa Dining Room. Spend your morning fertilizing soil, composting, planting, harvesting, and observing the produce that helps feed the local community. Please note, the dining room is adjacent to the farm. Clients who enjoy St. Vincent's daily meal services are likely to be present on site, many of whom are unsheltered.
...
Volunteers still needed: 13`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00008mT9BbMAK",date:"2026-10-23"},{name:"BINGO! at Osborn Pointe",description:`Osborn Pointe is a 48-unit supportive housing community designed to serve individuals 55 and over.
...
Volunteers still needed: 3`,link:"https://www.handsonphoenix.org/opportunity/a0CUi000093l3iVMAQ",date:"2026-10-23"}]},Cg={title:"City of Flagstaff",note:null,opportunities:[{name:"FACTS LIGHTS ON! Booth",description:`Educational Booth Volunteer\r
\r
...
Time: 6:15 PM - 8:15 PM`}]};var _l,Fl;const Io=((Fl=(_l=br.handsOnGreaterPhoenix)==null?void 0:_l.opportunities)==null?void 0:Fl.length)>0?br.handsOnGreaterPhoenix:wc,bg={...Io,note:'For referral volunteer opportunities (marked "Referral" in the title), please contact HandsOn Greater Phoenix to confirm whether volunteer hours can be verified for that project before signing up.',opportunities:Io===wc?Io.opportunities.filter(e=>Hr(e.date)):vc(Io.opportunities).map(e=>({...e,link:e.link||"https://www.handsonphoenix.org/calendar"}))};var Hl,Bl;const Uo=((Bl=(Hl=br.cityOfFlagstaff)==null?void 0:Hl.opportunities)==null?void 0:Bl.length)>0?br.cityOfFlagstaff:kc,xg={...Uo,opportunities:Uo===kc?Uo.opportunities.filter(e=>Hr(e.date)):vc(Uo.opportunities).map(e=>({...e,link:e.link||"https://volunteer.flagstaffaz.gov/Calendar"}))},ye={handsOnGreaterPhoenix:bg,arizonaStateParks:{title:"Arizona State Parks and Trails",note:`Note: The following opportunities require an application, which can be done through this link:
