...
Volunteers still needed: 3`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00008EsINUMA3",date:"2026-08-27"},{name:"Morning Kitchen Crew at St. Vincent de Paul",description:`We need your help to prepare and clean up as we create over 4,000 meals in the St. Vincent de Paul kitchen! No kitchen experience necessary.
...
Volunteers still needed: 5`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00008mZDXBMA4",date:"2026-10-03"},{name:"Garden Volunteers with St. Vincent de Paul (Main Campus)",description:`St. Vincent de Paul's three urban farms produce nutritionally dense food for those who do not have access to proper vitamins and nutrients. Annually, they grow 27,000 pounds of produce, which goes directly to SVdP's kitchens to be prepared for individuals and families experiencing homelessness and food insecurity, or delivered directly to families’ doors.
...
Time: 6:15 PM - 8:15 PM`}]};var _l,Fl;const zo=((Fl=(_l=br.handsOnGreaterPhoenix)==null?void 0:_l.opportunities)==null?void 0:Fl.length)>0?br.handsOnGreaterPhoenix:wc,bg={...zo,note:'For referral volunteer opportunities (marked "Referral" in the title), please contact HandsOn Greater Phoenix to confirm whether volunteer hours can be verified for that project before signing up.',opportunities:zo===wc?zo.opportunities.filter(e=>Hr(e.date)):vc(zo.opportunities).map(e=>({...e,link:e.link||"https://www.handsonphoenix.org/calendar"}))};var Hl,Bl;const Wo=((Bl=(Hl=br.cityOfFlagstaff)==null?void 0:Hl.opportunities)==null?void 0:Bl.length)>0?br.cityOfFlagstaff:kc,Mg={...Wo,opportunities:Wo===kc?Wo.opportunities.filter(e=>Hr(e.date)):vc(Wo.opportunities).map(e=>({...e,link:e.link||"https://volunteer.flagstaffaz.gov/Calendar"}))},ye={handsOnGreaterPhoenix:bg,arizonaStateParks:{title:"Arizona State Parks and Trails",note:`Note: The following opportunities require an application, which can be done through this link:
