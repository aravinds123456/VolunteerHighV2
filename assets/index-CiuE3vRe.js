 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Dc=P,_c=Symbol.for("react.element"),Fc=Symbol.for("react.fragment"),Hc=Object.prototype.hasOwnProperty,Bc=Dc.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Yc={key:!0,ref:!0,__self:!0,__source:!0};function tu(e,n,t){var o,r={},i=null,a=null;t!==void 0&&(i=""+t),n.key!==void 0&&(i=""+n.key),n.ref!==void 0&&(a=n.ref);for(o in n)Hc.call(n,o)&&!Yc.hasOwnProperty(o)&&(r[o]=n[o]);if(e&&e.defaultProps)for(o in n=e.defaultProps,n)r[o]===void 0&&(r[o]=n[o]);return{$$typeof:_c,type:e,key:i,ref:a,props:r,_owner:Bc.current}}br.Fragment=Fc;br.jsx=tu;br.jsxs=tu;Yl.exports=br;var h=Yl.exports,Si={},ou={exports:{}},be={},ru={exports:{}},iu={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(M,E){var j=M.length;M.push(E);e:for(;0<j;){var D=j-1>>>1,ee=M[D];if(0<r(ee,E))M[D]=E,M[j]=ee,j=D;else break e}}function t(M){return M.length===0?null:M[0]}function o(M){if(M.length===0)return null;var E=M[0],j=M.pop();if(j!==E){M[0]=j;e:for(var D=0,ee=M.length,vo=ee>>>1;D<vo;){var Vn=2*(D+1)-1,Br=M[Vn],En=Vn+1,wo=M[En];if(0>r(Br,j))En<ee&&0>r(wo,Br)?(M[D]=wo,M[En]=j,D=En):(M[D]=Br,M[Vn]=j,D=Vn);else if(En<ee&&0>r(wo,j))M[D]=wo,M[En]=j,D=En;else break e}}return E}function r(M,E){var j=M.sortIndex-E.sortIndex;return j!==0?j:M.id-E.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var a=Date,s=a.now();e.unstable_now=function(){return a.now()-s}}var l=[],u=[],f=1,c=null,m=3,y=!1,v=!1,k=!1,b=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(M){for(var E=t(u);E!==null;){if(E.callback===null)o(u);else if(E.startTime<=M)o(u),E.sortIndex=E.expirationTime,n(l,E);else break;E=t(u)}}function w(M){if(k=!1,g(M),!v)if(t(l)!==null)v=!0,$n(x);else{var E=t(u);E!==null&&Oe(w,E.startTime-M)}}function x(M,E){v=!1,k&&(k=!1,p(V),V=-1),y=!0;var j=m;try{for(g(E),c=t(l);c!==null&&(!(c.expirationTime>E)||M&&!K());){var D=c.callback;if(typeof D=="function"){c.callback=null,m=c.priorityLevel;var ee=D(c.expirationTime<=E);E=e.unstable_now(),typeof ee=="function"?c.callback=ee:c===t(l)&&o(l),g(E)}else o(l);c=t(l)}if(c!==null)var vo=!0;else{var Vn=t(u);Vn!==null&&Oe(w,Vn.startTime-E),vo=!1}return vo}finally{c=null,m=j,y=!1}}var C=!1,T=null,V=-1,R=5,L=-1;function K(){return!(e.unstable_now()-L<R)}function q(){if(T!==null){var M=e.unstable_now();L=M;var E=!0;try{E=T(!0,M)}finally{E?Ne():(C=!1,T=null)}}else C=!1}var Ne;if(typeof d=="function")Ne=function(){d(q)};else if(typeof MessageChannel<"u"){var X=new MessageChannel,$e=X.port2;X.port1.onmessage=q,Ne=function(){$e.postMessage(null)}}else Ne=function(){b(q,0)};function $n(M){T=M,C||(C=!0,Ne())}function Oe(M,E){V=b(function(){M(e.unstable_now())},E)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(M){M.callback=null},e.unstable_continueExecution=function(){v||y||(v=!0,$n(x))},e.unstable_forceFrameRate=function(M){0>M||125<M?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<M?Math.floor(1e3/M):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return t(l)},e.unstable_next=function(M){switch(m){case 1:case 2:case 3:var E=3;break;default:E=m}var j=m;m=E;try{return M()}finally{m=j}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(M,E){switch(M){case 1:case 2:case 3:case 4:case 5:break;default:M=3}var j=m;m=M;try{return E()}finally{m=j}},e.unstable_scheduleCallback=function(M,E,j){var D=e.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?D+j:D):j=D,M){case 1:var ee=-1;break;case 2:ee=250;break;case 5:ee=1073741823;break;case 4:ee=1e4;break;default:ee=5e3}return ee=j+ee,M={id:f++,callback:E,priorityLevel:M,startTime:j,expirationTime:ee,sortIndex:-1},j>D?(M.sortIndex=j,n(u,M),t(l)===null&&M===t(u)&&(k?(p(V),V=-1):k=!0,Oe(w,j-D))):(M.sortIndex=ee,n(l,M),v||y||(v=!0,$n(x))),M},e.unstable_shouldYield=K,e.unstable_wrapCallback=function(M){var E=m;return function(){var j=m;m=E;try{return M.apply(this,arguments)}finally{m=j}}}})(iu);ru.exports=iu;var $c=ru.exports;/**
 * @license React
...
Volunteers still needed: 17`,link:"https://www.handsonphoenix.org/opportunity/a0CUi000080x2vZMAQ",date:"2026-09-05"},{name:"Maggie&#39;s Place Spruce Up",description:`Maggie’s Place provides safe housing and a nurturing community for homeless pregnant women, empowering them to thrive throughout their lifetime.
