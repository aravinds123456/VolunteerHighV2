 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Gc=P,_c=Symbol.for("react.element"),Fc=Symbol.for("react.fragment"),Hc=Object.prototype.hasOwnProperty,Bc=Gc.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Yc={key:!0,ref:!0,__self:!0,__source:!0};function tu(e,n,t){var o,r={},i=null,a=null;t!==void 0&&(i=""+t),n.key!==void 0&&(i=""+n.key),n.ref!==void 0&&(a=n.ref);for(o in n)Hc.call(n,o)&&!Yc.hasOwnProperty(o)&&(r[o]=n[o]);if(e&&e.defaultProps)for(o in n=e.defaultProps,n)r[o]===void 0&&(r[o]=n[o]);return{$$typeof:_c,type:e,key:i,ref:a,props:r,_owner:Bc.current}}br.Fragment=Fc;br.jsx=tu;br.jsxs=tu;Yl.exports=br;var p=Yl.exports,Si={},ou={exports:{}},be={},ru={exports:{}},iu={};/**
 * @license React
...
Volunteers still needed: 7`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00008pLyRNMA0",date:"2026-10-17"}]},Cg={title:"City of Flagstaff",note:null,opportunities:[{name:"FACTS LIGHTS ON! Booth",description:`Educational Booth Volunteer\r
\r
...
Time: 6:15 PM - 8:15 PM`}]};var _l,Fl;const Io=((Fl=(_l=xr.handsOnGreaterPhoenix)==null?void 0:_l.opportunities)==null?void 0:Fl.length)>0?xr.handsOnGreaterPhoenix:wc,xg={...Io,note:'For referral volunteer opportunities (marked "Referral" in the title), please contact HandsOn Greater Phoenix to confirm whether volunteer hours can be verified for that project before signing up.',opportunities:Io===wc?Io.opportunities.filter(e=>Hr(e.date)):vc(Io.opportunities).map(e=>({...e,link:e.link||"https://www.handsonphoenix.org/calendar"}))};var Hl,Bl;const Uo=((Bl=(Hl=xr.cityOfFlagstaff)==null?void 0:Hl.opportunities)==null?void 0:Bl.length)>0?xr.cityOfFlagstaff:kc,bg={...Uo,opportunities:Uo===kc?Uo.opportunities.filter(e=>Hr(e.date)):vc(Uo.opportunities).map(e=>({...e,link:e.link||"https://volunteer.flagstaffaz.gov/Calendar"}))},ye={handsOnGreaterPhoenix:xg,arizonaStateParks:{title:"Arizona State Parks and Trails",note:`Note: The following opportunities require an application, which can be done through this link:
