 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Gc=P,Fc=Symbol.for("react.element"),_c=Symbol.for("react.fragment"),Hc=Object.prototype.hasOwnProperty,Bc=Gc.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Yc={key:!0,ref:!0,__self:!0,__source:!0};function tu(e,n,t){var o,r={},i=null,a=null;t!==void 0&&(i=""+t),n.key!==void 0&&(i=""+n.key),n.ref!==void 0&&(a=n.ref);for(o in n)Hc.call(n,o)&&!Yc.hasOwnProperty(o)&&(r[o]=n[o]);if(e&&e.defaultProps)for(o in n=e.defaultProps,n)r[o]===void 0&&(r[o]=n[o]);return{$$typeof:Fc,type:e,key:i,ref:a,props:r,_owner:Bc.current}}xr.Fragment=_c;xr.jsx=tu;xr.jsxs=tu;Yl.exports=xr;var h=Yl.exports,bi={},ou={exports:{}},xe={},ru={exports:{}},iu={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(M,L){var j=M.length;M.push(L);e:for(;0<j;){var G=j-1>>>1,ee=M[G];if(0<r(ee,L))M[G]=L,M[j]=ee,j=G;else break e}}function t(M){return M.length===0?null:M[0]}function o(M){if(M.length===0)return null;var L=M[0],j=M.pop();if(j!==L){M[0]=j;e:for(var G=0,ee=M.length,vo=ee>>>1;G<vo;){var Vn=2*(G+1)-1,Br=M[Vn],Ln=Vn+1,wo=M[Ln];if(0>r(Br,j))Ln<ee&&0>r(wo,Br)?(M[G]=wo,M[Ln]=j,G=Ln):(M[G]=Br,M[Vn]=j,G=Vn);else if(Ln<ee&&0>r(wo,j))M[G]=wo,M[Ln]=j,G=Ln;else break e}}return L}function r(M,L){var j=M.sortIndex-L.sortIndex;return j!==0?j:M.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var a=Date,s=a.now();e.unstable_now=function(){return a.now()-s}}var l=[],u=[],f=1,c=null,m=3,y=!1,v=!1,k=!1,x=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(M){for(var L=t(u);L!==null;){if(L.callback===null)o(u);else if(L.startTime<=M)o(u),L.sortIndex=L.expirationTime,n(l,L);else break;L=t(u)}}function w(M){if(k=!1,g(M),!v)if(t(l)!==null)v=!0,Zn(C);else{var L=t(u);L!==null&&Ne(w,L.startTime-M)}}function C(M,L){v=!1,k&&(k=!1,p(V),V=-1),y=!0;var j=m;try{for(g(L),c=t(l);c!==null&&(!(c.expirationTime>L)||M&&!$());){var G=c.callback;if(typeof G=="function"){c.callback=null,m=c.priorityLevel;var ee=G(c.expirationTime<=L);L=e.unstable_now(),typeof ee=="function"?c.callback=ee:c===t(l)&&o(l),g(L)}else o(l);c=t(l)}if(c!==null)var vo=!0;else{var Vn=t(u);Vn!==null&&Ne(w,Vn.startTime-L),vo=!1}return vo}finally{c=null,m=j,y=!1}}var S=!1,T=null,V=-1,R=5,E=-1;function $(){return!(e.unstable_now()-E<R)}function q(){if(T!==null){var M=e.unstable_now();E=M;var L=!0;try{L=T(!0,M)}finally{L?Oe():(S=!1,T=null)}}else S=!1}var Oe;if(typeof d=="function")Oe=function(){d(q)};else if(typeof MessageChannel<"u"){var X=new MessageChannel,Ze=X.port2;X.port1.onmessage=q,Oe=function(){Ze.postMessage(null)}}else Oe=function(){x(q,0)};function Zn(M){T=M,S||(S=!0,Oe())}function Ne(M,L){V=x(function(){M(e.unstable_now())},L)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(M){M.callback=null},e.unstable_continueExecution=function(){v||y||(v=!0,Zn(C))},e.unstable_forceFrameRate=function(M){0>M||125<M?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<M?Math.floor(1e3/M):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return t(l)},e.unstable_next=function(M){switch(m){case 1:case 2:case 3:var L=3;break;default:L=m}var j=m;m=L;try{return M()}finally{m=j}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(M,L){switch(M){case 1:case 2:case 3:case 4:case 5:break;default:M=3}var j=m;m=M;try{return L()}finally{m=j}},e.unstable_scheduleCallback=function(M,L,j){var G=e.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?G+j:G):j=G,M){case 1:var ee=-1;break;case 2:ee=250;break;case 5:ee=1073741823;break;case 4:ee=1e4;break;default:ee=5e3}return ee=j+ee,M={id:f++,callback:L,priorityLevel:M,startTime:j,expirationTime:ee,sortIndex:-1},j>G?(M.sortIndex=j,n(u,M),t(l)===null&&M===t(u)&&(k?(p(V),V=-1):k=!0,Ne(w,j-G))):(M.sortIndex=ee,n(l,M),v||y||(v=!0,Zn(C))),M},e.unstable_shouldYield=$,e.unstable_wrapCallback=function(M){var L=m;return function(){var j=m;m=L;try{return M.apply(this,arguments)}finally{m=j}}}})(iu);ru.exports=iu;var Zc=ru.exports;/**
 * @license React
...
Volunteers still needed: 6`,link:"https://www.handsonphoenix.org/opportunity/a0CUi000082oQrpMAE",date:"2026-08-22"},{name:"Classroom Prep Pros at Southwest Autism Research & Resource Center",description:`SARRC's mission is to advance research and provide a lifetime of support for individuals with autism and their families.
...
Volunteers still needed: 4`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00008WPNFrMAP",date:"2026-09-04"},{name:"From the Ground Up: Volunteer Day at the Ranch (Referral)",description:`Join us for a meaningful day of giving back at Wildcat Ranch Phoenix! This in-person volunteer event is a wonderful opportunity to roll up your sleeves, enjoy the outdoors, and make a direct impact on the ranch and the horses who call it home.
...
Volunteers still needed: 22`,link:"https://www.handsonphoenix.org/opportunity/a0CUi000080x2vZMAQ",date:"2026-09-05"},{name:"Maggie&#39;s Place Spruce Up",description:`Maggie’s Place provides safe housing and a nurturing community for homeless pregnant women, empowering them to thrive throughout their lifetime.
...
Volunteers still needed: 2`,link:"https://www.handsonphoenix.org/opportunity/a0CUi000089mzHmMAI",date:"2026-09-10"},{name:"Stove to Table - Kitchen volunteers needed (Referral)",description:`Advance's Stove to Table program delivers healthy, made from scratch meals for seniors living in subsidized housing in Maricopa County. This population experiences disproportionately high levels of food insecurity and chronic illness and our hot, fresh meals go a long way to help ease this burden and improve their quality of life. 
...
Volunteers still needed: 2`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00008cFxsFMAS",date:"2026-09-10"},{name:"Game Night at MANA House",description:`Bring your A-game for this fun social event at MANA House, a peer-support organization of homeless and formerly homeless veterans! Volunteers will facilitate Bingo for the Veterans residing at the facility. Join us to help bring joy to those who have valiantly served our country.
...
Volunteers still needed: 3`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00008Y8WESMA3",date:"2026-09-11"},{name:"9/11 Weekend of Service: Evening Meal Service at St. Vincent de Paul- Phoenix",description:`Those who are experiencing homelessness and food insecurity do not know where or when their next meal is coming. SVdP’s dining rooms around the Valley are thriving places where these individuals can come not only for a hot, nutritious meal and a smile, but to find supportive wrap-around services such as shelter, clothing, medical attention, and housing services. Volunteers create an experience many of us take for granted, an opportunity to feel welcome and part of a family.
...
Volunteers still needed: 0`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00007xGltbMAC",date:"2026-09-12"},{name:"9/11 Service Weekend: Afternoon Sort and Pack at St. Mary&#39;s Food Bank- Phoenix",description:`Bring your helping hands to sort, pack, and distribute food that will go to other nonprofits and families in crisis at St. Mary's Food Bank Alliance. You will have a blast meeting new people while working the assembly line!
...
Volunteers still needed: 100`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00008rhDKOMA2",date:"2026-09-19"},{name:"Medical Sort and Pack at Project C.U.R.E.",description:`Bring hope and health to the world with Project C.U.R.E., a national faith-based organization! Join us as we sort and pack desperately needed medical supplies that are shipped to hospitals, clinics, and orphanages in over 100 poverty stricken countries worldwide! Volunteers will meet new people and learn a lot about medical supplies and the urgent needs of them in under-resourced countries around the world.
...
Volunteers still needed: 9`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00007YdU2CMAV",date:"2026-09-25"},{name:"Four Peaks Area Bocce Competition in Gilbert (Referral)",description:`Join Special Olympics Arizona for a Four Peaks Area Bocce Competition in Gilbert!
...
Volunteers still needed: 4`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00008WLuonMAD",date:"2026-09-25"},{name:"September 2026 #TrashTag Cleanup and Stinknet Removal–Tempe Town Lake (Referral)",description:`Join Keep Tempe Beautiful on Saturday, September 26th to clean up Tempe Town Lake and remove invasive stinknet.
...
Volunteers still needed: 60`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00008Da9IzMAJ",date:"2026-09-26"},{name:"Nature Nurturers at Escalante Community Garden",description:`The Escalante Community Garden is a garden that follows a communal model with healthy growing practices. A portion of the garden’s harvest is given to Tempe Community Action Agency's Food Pantry to supplement emergency food boxes. The garden features a children's area, as well as a desert and herb garden.
...
Volunteers still needed: 9`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00008mZDXBMA4",date:"2026-10-03"},{name:"Garden Volunteers with St. Vincent de Paul (Main Campus)",description:`St. Vincent de Paul's three urban farms produce nutritionally dense food for those who do not have access to proper vitamins and nutrients. Annually, they grow 27,000 pounds of produce, which goes directly to SVdP's kitchens to be prepared for individuals and families experiencing homelessness and food insecurity, or delivered directly to families’ doors.
...
Volunteers still needed: 29`,link:"https://www.handsonphoenix.org/opportunity/a0CUi00008qwTM6MAM",date:"2026-10-03"},{name:"Maggie&#39;s Place Spruce Up",description:`Maggie’s Place provides safe housing and a nurturing community for homeless pregnant women, empowering them to thrive throughout their lifetime.
...
• Fix-It Clinic Assist - See "Activity Description" (15 spots available)
...
Time: 6:15 PM - 8:15 PM`}]};var Fl,_l;const zo=((_l=(Fl=Cr.handsOnGreaterPhoenix)==null?void 0:Fl.opportunities)==null?void 0:_l.length)>0?Cr.handsOnGreaterPhoenix:wc,Cg={...zo,note:'For referral volunteer opportunities (marked "Referral" in the title), please contact HandsOn Greater Phoenix to confirm whether volunteer hours can be verified for that project before signing up.',opportunities:zo===wc?zo.opportunities.filter(e=>Hr(e.date)):vc(zo.opportunities).map(e=>({...e,link:e.link||"https://www.handsonphoenix.org/calendar"}))};var Hl,Bl;const Wo=((Bl=(Hl=Cr.cityOfFlagstaff)==null?void 0:Hl.opportunities)==null?void 0:Bl.length)>0?Cr.cityOfFlagstaff:kc,xg={...Wo,opportunities:Wo===kc?Wo.opportunities.filter(e=>Hr(e.date)):vc(Wo.opportunities).map(e=>({...e,link:e.link||"https://volunteer.flagstaffaz.gov/Calendar"}))},ye={handsOnGreaterPhoenix:Cg,arizonaStateParks:{title:"Arizona State Parks and Trails",note:`Note: The following opportunities require an application, which can be done through this link:
