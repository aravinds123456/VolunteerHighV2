 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(M,L){var j=M.length;M.push(L);e:for(;0<j;){var G=j-1>>>1,ee=M[G];if(0<r(ee,L))M[G]=L,M[j]=ee,j=G;else break e}}function t(M){return M.length===0?null:M[0]}function o(M){if(M.length===0)return null;var L=M[0],j=M.pop();if(j!==L){M[0]=j;e:for(var G=0,ee=M.length,vo=ee>>>1;G<vo;){var Vn=2*(G+1)-1,Br=M[Vn],Ln=Vn+1,wo=M[Ln];if(0>r(Br,j))Ln<ee&&0>r(wo,Br)?(M[G]=wo,M[Ln]=j,G=Ln):(M[G]=Br,M[Vn]=j,G=Vn);else if(Ln<ee&&0>r(wo,j))M[G]=wo,M[Ln]=j,G=Ln;else break e}}return L}function r(M,L){var j=M.sortIndex-L.sortIndex;return j!==0?j:M.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var a=Date,s=a.now();e.unstable_now=function(){return a.now()-s}}var l=[],u=[],f=1,c=null,m=3,y=!1,v=!1,k=!1,x=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(M){for(var L=t(u);L!==null;){if(L.callback===null)o(u);else if(L.startTime<=M)o(u),L.sortIndex=L.expirationTime,n(l,L);else break;L=t(u)}}function w(M){if(k=!1,g(M),!v)if(t(l)!==null)v=!0,Zn(C);else{var L=t(u);L!==null&&Oe(w,L.startTime-M)}}function C(M,L){v=!1,k&&(k=!1,p(V),V=-1),y=!0;var j=m;try{for(g(L),c=t(l);c!==null&&(!(c.expirationTime>L)||M&&!$());){var G=c.callback;if(typeof G=="function"){c.callback=null,m=c.priorityLevel;var ee=G(c.expirationTime<=L);L=e.unstable_now(),typeof ee=="function"?c.callback=ee:c===t(l)&&o(l),g(L)}else o(l);c=t(l)}if(c!==null)var vo=!0;else{var Vn=t(u);Vn!==null&&Oe(w,Vn.startTime-L),vo=!1}return vo}finally{c=null,m=j,y=!1}}var S=!1,T=null,V=-1,I=5,E=-1;function $(){return!(e.unstable_now()-E<I)}function q(){if(T!==null){var M=e.unstable_now();E=M;var L=!0;try{L=T(!0,M)}finally{L?Ne():(S=!1,T=null)}}else S=!1}var Ne;if(typeof d=="function")Ne=function(){d(q)};else if(typeof MessageChannel<"u"){var X=new MessageChannel,Ze=X.port2;X.port1.onmessage=q,Ne=function(){Ze.postMessage(null)}}else Ne=function(){x(q,0)};function Zn(M){T=M,S||(S=!0,Ne())}function Oe(M,L){V=x(function(){M(e.unstable_now())},L)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(M){M.callback=null},e.unstable_continueExecution=function(){v||y||(v=!0,Zn(C))},e.unstable_forceFrameRate=function(M){0>M||125<M?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):I=0<M?Math.floor(1e3/M):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return t(l)},e.unstable_next=function(M){switch(m){case 1:case 2:case 3:var L=3;break;default:L=m}var j=m;m=L;try{return M()}finally{m=j}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(M,L){switch(M){case 1:case 2:case 3:case 4:case 5:break;default:M=3}var j=m;m=M;try{return L()}finally{m=j}},e.unstable_scheduleCallback=function(M,L,j){var G=e.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?G+j:G):j=G,M){case 1:var ee=-1;break;case 2:ee=250;break;case 5:ee=1073741823;break;case 4:ee=1e4;break;default:ee=5e3}return ee=j+ee,M={id:f++,callback:L,priorityLevel:M,startTime:j,expirationTime:ee,sortIndex:-1},j>G?(M.sortIndex=j,n(u,M),t(l)===null&&M===t(u)&&(k?(p(V),V=-1):k=!0,Oe(w,j-G))):(M.sortIndex=ee,n(l,M),v||y||(v=!0,Zn(C))),M},e.unstable_shouldYield=$,e.unstable_wrapCallback=function(M){var L=m;return function(){var j=m;m=L;try{return M.apply(this,arguments)}finally{m=j}}}})(iu);ru.exports=iu;var Zc=ru.exports;/**
 * @license React
